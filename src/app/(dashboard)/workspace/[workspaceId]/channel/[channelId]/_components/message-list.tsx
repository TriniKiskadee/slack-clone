...
const MessageList = () => {
    const [hasInitialScrolled, setHasInitialScrolled] =
    ...
    return (
        <div className={"relative h-full"}>
            <div
                className={
                    "h-full overflow-y-auto px-4 flex flex-col space-y-1"
                }
                ref={scrollRef}
                    ...
                    >
                        ...
                        {Array.from({ length: 9 }).map((_, index) => (
                            <div
                                key={index}
                                className={
                                    "flex items-center space-x-4 gap-3 mt-10"
                                }
                            >
                                <Skeleton
                                ...
                                <div className={"translate-y-[16px]"}>
                                    <div className="flex flex-row space-y-2 translate-[-18px] gap-1.5">
                                        <Skeleton
                                            className={"w-[46.58px] h-[16px]"}
                                        />
                                        <Skeleton
                                            className={"w-[139.16px] h-[12px]"}
                                        />
                                    </div>
                                    <div className={"space-y-1"}>
                                        <Skeleton
                                            className={
                                                "w-[857.61px] h-[20px] translate-y-[-16px] translate-x-[-18px]"
                                            }
                                        />
                                        <Skeleton
                                            className={
            ...
            {isFetchingNextPage && (
                <div
                    className={
                        "pointer-events-none absolute top-0 left-0 right-0 z-20 flex items-center justify-center py-2"
                    }
                >
                    <div
                        className={
                            "flex items-center gap-2 rounded-md bg-gradient-to-b from-white/80 to-transparent dark:from-neutral-900/80 backdrop-blur px-3 py-1"
                        }
                    >
                        <Loader2
                            className={
