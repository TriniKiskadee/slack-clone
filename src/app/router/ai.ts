...
import { aiSecurityMiddleware } from "@/app/middlewares/arkjet/ai";
...
export const generateCompose = base
	...
	.handler(async ({ input }) => {
		...
		const system = [
			...
			"Output strictly in Markdown (paragraphs and optional bullet lists). Do no output HTML or images.",
